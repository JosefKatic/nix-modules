...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    networking.firewall.interfaces."eno2".allowedTCPPorts = [53 80 3480 88 389 443 34443 464 636];
    networking.firewall.interfaces."eno2".allowedUDPPorts = [53 88 123 464];
