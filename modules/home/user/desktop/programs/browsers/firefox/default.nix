       ...
       profiles =
         {
           ...
           "alpha" = {
             ...
             search = cfg.firefox.search;
             settings = cfg.firefox.settings // stigConfig;
             userContent = import "${inputs.self}/modules/home/user/desktop/programs/browsers/firefox/alpha/user-content.nix";
             userChrome = import ./alpha/user-chrome.nix;
           };
           "cascade" = {
             id = 3;
             extensions = cfg.firefox.extensions;
             search = cfg.firefox.search;
             settings = cfg.firefox.settings // stigConfig;
             userContent = import ./cascade/user-content.nix;
             userChrome = import ./cascade/user-chrome.nix;
           };
           "minimal" = {
             id = 4;
             extensions = cfg.firefox.extensions;
             search = cfg.firefox.search;
             settings = cfg.firefox.settings // stigConfig;
             userContent = import ./minimal/user-content.nix;
             userChrome = import ./minimal/user-chrome.nix;
           };
         }
         // cfg.firefox.profiles
         // {
           ${cfg.firefox.defaultProfile}.isDefault = true;
         };
     };
   };
 }
